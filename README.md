...
- [did-i-stutter](skills/did-i-stutter/README.md) - Stops the agent from substituting its own guess about what the user wants for what the user actually said, and requires it to ask instead of assume when the two genuinely diverge.
